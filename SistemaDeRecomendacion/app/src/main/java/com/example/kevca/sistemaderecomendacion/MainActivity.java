...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(UsuarioBL.Companion.getInstance().read(UsuarioBL.Companion.getSession()).getTipo()==1){
            navigationView.getMenu().findItem(R.id.nav_usuario).setVisible(false);
        }else{
            navigationView.getMenu().findItem(R.id.nav_usuario).setVisible(true);
        }
    }
